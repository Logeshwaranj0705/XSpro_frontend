...
const MessagerDataSchedule = ({ status = [] ,onSeeMore}) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 min-h-[240px] flex flex-col h-full">
      ...
      <div className="flex flex-col">
        <h5 className="text-lg font-medium">Messager Reocrds Preview</h5>
      ...
      <div className="mt-6 relative flex-1 min-h-[400px]  max-h-[400px] overflow-y-auto">
        {hasData &&
...
export default MessagerDataSchedule;
